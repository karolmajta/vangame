...
// HELPER FUNCTIONS FOR GETTING ABSOLUTE POSITIONS OF ELEMENTS
...
// PLACEHOLDERS FOR MOUSE COORDINATES ETC.
...
// THESE VARIABLE AND FUNCTION KEEP TRACK OF THE AMOUNT OF KBYTES LOADED
VG.KBYTESLOADED = 0;
...
/*           VG.Event                             */
/*                                                */
/*     Event - PyGame-style event object          */
/**************************************************/
...
/*           VG.EQ                                */
/*                                                */
/*     Events queue - handles all game related    */
/*     events like in PyGame                      */
/**************************************************/
VG.EQ = function() {
	var Self = this;
...
/*          VG.Screen                             */
/*                                                */
/*     Used for storage of in-game objects        */
/*     and for connecting the game-scene to       */
/*     <canvas> element.                          */
/**************************************************/
VG.Screen = function(){
	var Self = this;
...
/*           VG.Canvas                            */
/*                                                */
/*     Represents <canvas> element and takes      */
/*     care of handling its position relative to  */
/*     the screen.                                */
/**************************************************/
...
/*     loads only once                            */
/**************************************************/
VG.Image = function(url, callback, data_url){
	var Self = this;
...
VG.Sprite = function(path, callback, data_url){
	var Self = this;
	this.x = 0;
	this.y = 0;
	this.pnt = -1;
...
/*           VG.Rect                              */
/*                                                */
/*     Very basic and useful for debugging.       */
/*     All sprites contain rects for colission    */
/*     detection and drawing                      */
/**************************************************/
VG.Rect = function(x, y, w, h){
	this.x = x;
	this.y = y;
	this.width = w;
	this.height = h;
...
/*           VG.Ellipse                           */
/*                                                */
/*     Canvas lacks native ellipse primitive      */
/*     so this one is created by scalling a       */
/*     circle                                     */
/**************************************************/
VG.Ellipse = function(x, y, a, b){
	this.x = x;
	this.y = y;
	this.a = a;
	this.b = b
